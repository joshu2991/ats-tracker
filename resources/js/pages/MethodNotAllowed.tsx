                    ...
                    <div className="flex flex-col items-center justify-center text-center">
                        ...
                        >
                            <div className="relative">
                                ...
                                <div className="absolute -top-2 -right-2 w-12 h-12 bg-amber-600 rounded-full flex items-center justify-center shadow-md">
                                    <span className="text-2xl font-bold text-white">405</span>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <p className="text-xl leading-relaxed text-slate-600 mb-6">
                                ...
                                Please check the URL and try again with the correct method.
                            </p>
                        </motion.div>
                        ...
                        >
                            <div className="flex flex-col gap-1">
                                <span className="text-2xl sm:text-3xl md:text-4xl font-bold text-amber-600">405</span>
                                <span className="text-xs sm:text-sm text-slate-500">Error Code</span>
                            </div>
                            <div className="flex flex-col gap-1">
                                <span className="text-2xl sm:text-3xl md:text-4xl font-bold text-amber-600">Oops!</span>
                                <span className="text-xs sm:text-sm text-slate-500">Wrong Method</span>
                            </div>
                            <div className="flex flex-col gap-1">
                                <span className="text-2xl sm:text-3xl md:text-4xl font-bold text-amber-600">100%</span>
                                <span className="text-xs sm:text-sm text-slate-500">Easy Fix</span>
                            </div>
                        </motion.div>
                    </div>
                </main>
